...
public class GameMain extends JPanel implements MouseListener{
	...
	public GameMain() {   
		...
		//++ adding the MouseListener to 'this'
		...
		// ++ added new instance of the game Board class
		board = new Board ();
		
		//TODO: call the method to initialise the game board
		// ++ calling the initGame method
		initGame();
	...
	public static void main(String[] args) {
		...
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
	         public void run() {
				...
				//++ using add method to add the instance of this game. game starts by calling the GameMain()
	  ...
	  /** Initialise the game-board contents and the current status of GameState and Player) */
		...
		public void updateGame(Player thePlayer, int row, int col) {
			...
			if(board.hasWon(thePlayer, row, col)) {
				...
				//++ this is to check if player cross won, else player nought won
